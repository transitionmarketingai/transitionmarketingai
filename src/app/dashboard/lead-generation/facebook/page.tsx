...
export default function FacebookLeadGenPage() {
  const [campaigns] = useState([
    {
      id: 1,
      name: 'Business Services Campaign',
      status: 'active',
      budget: 5000,
      spent: 3250,
      impressions: 45200,
    ...
    <div className="p-6 space-y-6">
      ...
      <Card className="bg-blue-50 border-blue-200">
        <CardContent className="pt-6">
          <h3 className="font-semibold mb-2">How Facebook Lead Ads Work</h3>
          <ul className="space-y-2 text-sm text-gray-700">
            <li>✓ Your ad appears in Facebook News Feed</li>
            <li>✓ Users click → Instant form opens (pre-filled)</li>
            <li>✓ Lead submits → Appears in your dashboard instantly</li>
            <li>✓ You get WhatsApp notification</li>
            <li>✓ Start conversation immediately</li>
          </ul>
        </CardContent>
      </Card>
    </div>
