    ...
    <div className="p-6 space-y-6">
      ...
      <Card className="bg-red-50 border-red-200">
        <CardContent className="pt-6">
          <h3 className="font-semibold mb-2">Google Lead Forms - How It Works</h3>
          <ul className="space-y-2 text-sm text-gray-700">
            <li>✓ User searches Google (e.g., "3BHK flat Mumbai")</li>
            <li>✓ Your ad appears with "Get More Info" button</li>
            <li>✓ Lead form extension opens instantly</li>
