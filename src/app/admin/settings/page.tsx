  ...
  return (
    <div className="p-8 max-w-7xl mx-auto">
      <div className="mb-8">
        ...
        <p className="text-slate-600">Configure admin account and platform settings</p>
      </div>
      ...
      <Card>
        <CardContent className="p-12 text-center">
          ...
          <p className="text-slate-600 mb-6">Manage admin account settings and platform configuration.</p>
