    ...
    <div className="p-8 max-w-7xl mx-auto">
      ...
      <Card>
        <CardContent className="p-12 text-center">
          ...
          <p className="text-slate-600 mb-6">View and manage invoices, payments, and billing for all clients.</p>
          <p className="text-sm text-slate-500">This feature will be available soon. For now, generate invoices from individual client pages.</p>
        </CardContent>
      </Card>
    </div>
  );
